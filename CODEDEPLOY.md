...
```
aws deploy push --application-name CodeDeployDemo --s3-location s3://aws-devops-course-jagruti/codedeploy-demo/app.zip --ignore-hidden-files --region eu-west-1 --profile aws-devops
```